...
char *GetClassNType(char *name, char *declaration, int *pclassNtype, int *pn) {
    char *p;
...
RtVoid RiSolidBegin(RtToken operation) {
    ...
    if (!strcmp(operation, "primitive") || !strcmp(operation, "intersection") || !strcmp(operation, "union") || !strcmp(operation, "difference")) {
...
RtVoid RiImplicit(RtInt a, RtInt b[], RtInt c, RtFloat d[], RtInt e, RtFloat f[], RtInt g, RtFloat h[], ...) {
    (void)a;
    (void)b;
    (void)c;
    (void)d;
...
RtVoid RiImplicitV(RtInt a, RtInt b[], RtInt c, RtFloat d[], RtInt e, RtFloat f[], RtInt g, RtFloat h[], RtInt n, RtToken tokens[], RtPointer parms[]) {
    (void)a;
    (void)b;
    (void)c;
    (void)d;
...
RtVoid RiSubdivisionMeshV(RtToken scheme, RtInt nfaces, RtInt nvertices[], RtInt vertices[], RtInt ntags, RtToken tags[], RtInt nargs[], RtInt intargs[], RtFloat floatargs[], RtInt n, RtToken tokens[], RtPointer parms[]) {
    register int l, v, i, a, ia, fa;
...
RtVoid RiArchiveRecord(RtToken type, char *format, ...) {
    ...
    if (gSRIBW.firstline == 2) {
         ...
         *    HandleFirstLine().
         */
        if (!hint || (hint && strncmp("RenderMan", format, sizeof("RenderMan") - 1))) {
...
RtLightHandle RiLightSource(RtToken name, ...) {
    ...
    light = (RtLightHandle)(size_t)gSRIBW.LastLightHandle++;
...
RtVoid RiNuCurves(RtInt ncurves, RtInt nvertices[], RtInt order[], RtFloat knot[], RtFloat min[], RtFloat max[], ...) {
...
RtVoid RiNuCurvesV(RtInt ncurves, RtInt nvertices[], RtInt order[], RtFloat knot[], RtFloat min[], RtFloat max[], RtInt n, RtToken tokens[], RtPointer parms[]) {
    int N; /* number of control vertices */
    int O; /* sum of order[] values */
    register int i;
...
RtVoid RiConeV(RtFloat height, RtFloat radius, RtFloat thetamax, RtInt n, RtToken tokens[], RtPointer parms[]) {
    if (!fp)
        return;
...
RtVoid RiCurvesV(RtToken type, RtInt ncurves, RtInt nvertices[], RtToken wrap, RtInt n, RtToken tokens[], RtPointer parms[]) {
    RtInt nonperiodic;
    RtInt uniform, varying, vertex;
    register RtInt i;
...
RtVoid RiCylinderV(RtFloat radius, RtFloat zmin, RtFloat zmax, RtFloat thetamax, RtInt n, RtToken tokens[], RtPointer parms[]) {
    if (!fp)
        return;
...
RtVoid RiDiskV(RtFloat height, RtFloat radius, RtFloat thetamax, RtInt n, RtToken tokens[], RtPointer parms[]) {
    if (!fp)
        return;
...
RtVoid RiHyperboloidV(RtPoint point1, RtPoint point2, RtFloat thetamax, RtInt n, RtToken tokens[], RtPointer parms[]) {
    if (!fp)
        return;
...
RtVoid RiParaboloidV(RtFloat rmax, RtFloat zmin, RtFloat zmax, RtFloat thetamax, RtInt n, RtToken tokens[], RtPointer parms[]) {
    if (!fp)
        return;
...
RtVoid RiSphereV(RtFloat radius, RtFloat zmin, RtFloat zmax, RtFloat thetamax, RtInt n, RtToken tokens[], RtPointer parms[]) {
    if (!fp)
        return;
...
RtVoid RiTorusV(RtFloat majorradius, RtFloat minorradius, RtFloat phimin, RtFloat phimax, RtFloat thetamax, RtInt n, RtToken tokens[], RtPointer parms[]) {
    if (!fp)
        return;
...
RtVoid RiGeneralPolygonV(RtInt nloops, RtInt nvertices[], RtInt n, RtToken tokens[], RtPointer parms[]) {
    register int i;
    register int v = 0;
...
RtVoid RiPointsGeneralPolygons(RtInt npolys, RtInt nloops[], RtInt nvertices[], RtInt vertices[], ...) {
    register int l, v, i;
    va_list ap;
...
RtVoid RiPointsGeneralPolygonsV(RtInt npolys, RtInt nloops[], RtInt nvertices[], RtInt vertices[], RtInt n, RtToken tokens[], RtPointer parms[]) {
    register int l, v, i;
...
RtVoid RiPointsPolygonsV(RtInt npolys, RtInt nvertices[], RtInt vertices[], RtInt n, RtToken tokens[], RtPointer parms[]) {
    register int l, v, i;
...
RtVoid RiDetailRange(RtFloat minvisible, RtFloat lowertransition, RtFloat uppertransition, RtFloat maxvisible) {
    if (!fp)
        return;
...
RtVoid RiOrientation(RtToken orientation) {
    ...
    if (!strcmp(orientation, "lh") || !strcmp(orientation, "rh")) {
        CheckIfFirstLine();
...
RtVoid RiMakeBump(char *picturename, char *texturename, RtToken swrap, RtToken twrap, RtFilterFunc filterfunc, RtFloat swidth, RtFloat twidth, ...) {
    char *p;
    va_list ap;
...
RtVoid RiMakeBumpV(char *picturename, char *texturename, RtToken swrap, RtToken twrap, RtFilterFunc filterfunc, RtFloat swidth, RtFloat twidth, RtInt n, RtToken tokens[], RtPointer parms[]) {
    char *p;
...
RtVoid RiMakeCubeFaceEnvironment(char *px, char *nx, char *py, char *ny, char *pz, char *nz, char *texturename, RtFloat fov, RtFilterFunc filterfunc, RtFloat swidth, RtFloat twidth, ...) {
    char *p;
    va_list ap;
...
RtVoid RiMakeCubeFaceEnvironmentV(char *px, char *nx, char *py, char *ny, char *pz, char *nz, char *texturename, RtFloat fov, RtFilterFunc filterfunc, RtFloat swidth, RtFloat twidth, RtInt n, RtToken tokens[], RtPointer parms[]) {
    char *p;
...
RtVoid RiMakeLatLongEnvironment(char *picturename, char *texturename, RtFilterFunc filterfunc, RtFloat swidth, RtFloat twidth, ...) {
    char *p;
    va_list ap;
...
RtVoid RiMakeLatLongEnvironmentV(char *picturename, char *texturename, RtFilterFunc filterfunc, RtFloat swidth, RtFloat twidth, RtInt n, RtToken tokens[], RtPointer parms[]) {
    char *p;
...
RtVoid RiMakeShadowV(char *picturename, char *texturename, RtInt n, RtToken tokens[], RtPointer parms[]) {
    if (!fp)
        return;
...
RtVoid RiMakeTexture(char *picturename, char *texturename, RtToken swrap, RtToken twrap, RtFilterFunc filterfunc, RtFloat swidth, RtFloat twidth, ...) {
    char *p;
    va_list ap;
...
RtVoid RiMakeTextureV(char *picturename, char *texturename, RtToken swrap, RtToken twrap, RtFilterFunc filterfunc, RtFloat swidth, RtFloat twidth, RtInt n, RtToken tokens[], RtPointer parms[]) {
    char *p;
