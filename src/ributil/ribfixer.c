...
ar70ArchiveRecord(RtToken type, char *format, char *s),
    ar70GeneralPolygonV(RtInt nloops, RtInt nvertices[], RtInt n, RtToken tokens[], RtPointer parms[]),
    ar70NuPatchV(RtInt nu, RtInt uorder, RtFloat uknot[], RtFloat umin, RtFloat umax, RtInt nv, RtInt vorder, RtFloat vknot[], RtFloat vmin, RtFloat vmax, RtInt n, RtToken tokens[], RtPointer parms[]),
    ar70PointsGeneralPolygonsV(RtInt npolys, RtInt nloops[], RtInt nvertices[], RtInt vertices[], RtInt n, RtToken tokens[], RtPointer parms[]),
    ar70TextureCoordinates(RtFloat s1, RtFloat t1, RtFloat s2, RtFloat t2, RtFloat s3, RtFloat t3, RtFloat s4, RtFloat t4);
...
arzupAttributeBegin(void),
    ...
    arzupFrameEnd(void),
    arzupGeneralPolygonV(RtInt nloops, RtInt nvertices[], RtInt n, RtToken tokens[], RtPointer parms[]),
    arzupLightSourceV(RtToken name,
                      RtInt n,
                      RtToken tokens[],
                      RtPointer parms[]),
    arzupNuPatchV(RtInt nu, RtInt uorder, RtFloat uknot[], RtFloat umin, RtFloat umax, RtInt nv, RtInt vorder, RtFloat vknot[], RtFloat vmin, RtFloat vmax, RtInt n, RtToken tokens[], RtPointer parms[]),
    arzupPointsGeneralPolygonsV(RtInt npolys, RtInt nloops[], RtInt nvertices[], RtInt vertices[], RtInt n, RtToken tokens[], RtPointer parms[]),
...
a205AttributeV(RtToken name,
               ...
               RtToken tokens[],
               RtPointer parms[]),
    a205NuPatchV(RtInt nu, RtInt uorder, RtFloat uknot[], RtFloat umin, RtFloat umax, RtInt nv, RtInt vorder, RtFloat vknot[], RtFloat vmin, RtFloat vmax, RtInt n, RtToken tokens[], RtPointer parms[]),
    a205PointsGeneralPolygonsV(RtInt npolys, RtInt nloops[], RtInt nvertices[], RtInt vertices[], RtInt n, RtToken tokens[], RtPointer parms[]);
...
RtVoid
tpMakeBumpV(char *picturename, char *texturename, RtToken swrap, RtToken twrap, RtFilterFunc filterfunc, RtFloat swidth, RtFloat twidth, RtInt n, RtToken tokens[], RtPointer parms[]),
    tpMakeCubeFaceEnvironmentV(char *px, char *nx, char *py, char *ny, char *pz, char *nz, char *texturename, RtFloat fov, RtFilterFunc filterfunc, RtFloat swidth, RtFloat twidth, RtInt n, RtToken tokens[], RtPointer parms[]),
    tpMakeLatLongEnvironmentV(char *picturename, char *texturename, RtFilterFunc filterfunc, RtFloat swidth, RtFloat twidth, RtInt n, RtToken tokens[], RtPointer parms[]),
    tpMakeShadowV(char *picturename, char *texturename, RtInt n, RtToken tokens[], RtPointer parms[]),
    tpMakeTextureV(char *picturename, char *texturename, RtToken swrap, RtToken twrap, RtFilterFunc filterfunc, RtFloat swidth, RtFloat twidth, RtInt n, RtToken tokens[], RtPointer parms[]);
 ...
 */
RtVoid
upNuPatchV(RtInt nu, RtInt uorder, RtFloat uknot[], RtFloat umin, RtFloat umax, RtInt nv, RtInt vorder, RtFloat vknot[], RtFloat vmin, RtFloat vmax, RtInt n, RtToken tokens[], RtPointer parms[]),
    upTrimCurve(RtInt nloops, RtInt ncurves[], RtInt order[], RtFloat knot[], RtFloat min[], RtFloat max[], RtInt n[], RtFloat u[], RtFloat v[], RtFloat w[]);
...
void SwapYZCoordinate(int nvertices,
                      ...
                      RtToken tokens[],
                      RtPointer parms[]);
int Transpose9x5PwArray(RtInt nu, RtInt nv, RtInt n, RtToken tokens[], RtPointer parms[]);
...
int main(int argc, char **argv) {
    ...
    if (texpaths) {
        ...
        tp[TP_MAKECUBEFACEENVIRONMENT] = gRibRITable[kRIB_MAKECUBEFACEENVIRONMENT];
        tp[TP_MAKELATLONGENVIRONMENT] = gRibRITable[kRIB_MAKELATLONGENVIRONMENT];
        ...
        gRibRITable[kRIB_MAKECUBEFACEENVIRONMENT] = (PRIB_RIPROC)tpMakeCubeFaceEnvironmentV;
        gRibRITable[kRIB_MAKELATLONGENVIRONMENT] = (PRIB_RIPROC)tpMakeLatLongEnvironmentV;
    ...
    if (AliasZup) {
        ...
        arzup[ARZUP_POINTSGENERALPOLYGONS] = gRibRITable[kRIB_POINTSGENERALPOLYGONS];
        ...
        gRibRITable[kRIB_FRAMEBEGIN] = (PRIB_RIPROC)arzupFrameBegin;
        ...
        gRibRITable[kRIB_POINTSGENERALPOLYGONS] = (PRIB_RIPROC)arzupPointsGeneralPolygonsV;
        ...
        gRibRITable[kRIB_TRANSFORMBEGIN] = (PRIB_RIPROC)arzupTransformBegin;
        gRibRITable[kRIB_TRANSFORMEND] = (PRIB_RIPROC)arzupTransformEnd;
        gRibRITable[kRIB_WORLDBEGIN] = (PRIB_RIPROC)arzupWorldBegin;
     ...
     */
    if (AliasToRenderman82 || AliasToRenderman81 || AliasToRenderman80 || AliasToRenderman75 || AliasToRenderman70) {
        ...
        ar70[AR70_POINTSGENERALPOLYGONS] = gRibRITable[kRIB_POINTSGENERALPOLYGONS];
        ...
        gRibRITable[kRIB_POINTSGENERALPOLYGONS] = (PRIB_RIPROC)ar70PointsGeneralPolygonsV;
 ...
 */
RtVoid ar70GeneralPolygonV(RtInt nloops, RtInt nvertices[], RtInt n, RtToken tokens[], RtPointer parms[]) {
    /*
 ...
 *
 */
RtVoid ar70NuPatchV(RtInt nu, RtInt uorder, RtFloat uknot[], RtFloat umin, RtFloat umax, RtInt nv, RtInt vorder, RtFloat vknot[], RtFloat vmin, RtFloat vmax, RtInt n, RtToken tokens[], RtPointer parms[]) {
 ...
 * Check name attribute to see if set properly.
 */
RtVoid ar70PointsGeneralPolygonsV(RtInt npolys, RtInt nloops[], RtInt nvertices[], RtInt vertices[], RtInt n, RtToken tokens[], RtPointer parms[]) {
    /* Now check for missing name attribute. */
 ...
 */
RtVoid ar70TextureCoordinates(RtFloat s1, RtFloat t1, RtFloat s2, RtFloat t2, RtFloat s3, RtFloat t3, RtFloat s4, RtFloat t4) {
    if (0.0 == s1 && 0.0 == t1 && 0.0 == s2 && -1.0 == t2 && 1.0 == s3 && 0.0 == t3 && 1.0 == s4 && -1.0 == t4) {
        /* Skip it. */
        return;
    }
...
RtVoid arzupGeneralPolygonV(RtInt nloops, RtInt nvertices[], RtInt n, RtToken tokens[], RtPointer parms[]) {
    register int i;
    register int v = 0;
...
RtVoid arzupNuPatchV(RtInt nu, RtInt uorder, RtFloat uknot[], RtFloat umin, RtFloat umax, RtInt nv, RtInt vorder, RtFloat vknot[], RtFloat vmin, RtFloat vmax, RtInt n, RtToken tokens[], RtPointer parms[]) {
...
RtVoid arzupPointsGeneralPolygonsV(RtInt npolys, RtInt nloops[], RtInt nvertices[], RtInt vertices[], RtInt n, RtToken tokens[], RtPointer parms[]) {
    register int l, v, i;
...
RtVoid a205AttributeV(RtToken name,
    ...
    if (!strcmp(name, "identifier") && !strcmp(tokens[0], "name")) {
        s = *(char **)parms[0];
        while (*s == (char)0x7f)
            s++;
        if (s != *(char **)parms[0]) {
...
RtVoid a205NuPatchV(RtInt nu, RtInt uorder, RtFloat uknot[], RtFloat umin, RtFloat umax, RtInt nv, RtInt vorder, RtFloat vknot[], RtFloat vmin, RtFloat vmax, RtInt n, RtToken tokens[], RtPointer parms[]) {
    ...
    if (nu == 5 && uorder == 3 && umin == 0.0 && umax == 1.0 && nv == 9 && vorder == 3 && vmin == 0.0 && vmax == 1.0
...
RtVoid a205PointsGeneralPolygonsV(RtInt npolys, RtInt nloops[], RtInt nvertices[], RtInt vertices[], RtInt n, RtToken tokens[], RtPointer parms[]) {
    register int l, v, i;
...
RtVoid sk20AttributeV(RtToken name,
    ...
    s = *((RtString *)parms[0]);
    if (!strcmp(name, "identifier") && (!strcmp(tokens[0], "name") || !strcmp(tokens[0], "shadinggroup")) && *s == ' ') {
        t = s;
        s++;
        do {
            *t++ = *s;
...
RtVoid sk20LightSourceV(RtToken name,
    ...
    if (!strcmp(name, "spotlight") && !strcmp(tokens[0], "spotlight") && n && !strcmp(tokens[0], "falloff")) {
...
RtVoid tpMakeBumpV(char *picturename, char *texturename, RtToken swrap, RtToken twrap, RtFilterFunc filterfunc, RtFloat swidth, RtFloat twidth, RtInt n, RtToken tokens[], RtPointer parms[]) {
    auto char *s1, *s2;
...
RtVoid tpMakeCubeFaceEnvironmentV(char *px, char *nx, char *py, char *ny, char *pz, char *nz, char *texturename, RtFloat fov, RtFilterFunc filterfunc, RtFloat swidth, RtFloat twidth, RtInt n, RtToken tokens[], RtPointer parms[]) {
...
RtVoid tpMakeLatLongEnvironmentV(char *picturename, char *texturename, RtFilterFunc filterfunc, RtFloat swidth, RtFloat twidth, RtInt n, RtToken tokens[], RtPointer parms[]) {
    auto char *s1, *s2;
...
RtVoid tpMakeShadowV(char *picturename, char *texturename, RtInt n, RtToken tokens[], RtPointer parms[]) {
    auto char *s1, *s2;
...
RtVoid tpMakeTextureV(char *picturename, char *texturename, RtToken swrap, RtToken twrap, RtFilterFunc filterfunc, RtFloat swidth, RtFloat twidth, RtInt n, RtToken tokens[], RtPointer parms[]) {
    auto char *s1, *s2;
 ...
 *
 */
RtVoid upNuPatchV(RtInt nu, RtInt uorder, RtFloat uknot[], RtFloat umin, RtFloat umax, RtInt nv, RtInt vorder, RtFloat vknot[], RtFloat vmin, RtFloat vmax, RtInt n, RtToken tokens[], RtPointer parms[]) {
    int i;
    RtFloat udiff, vdiff;
