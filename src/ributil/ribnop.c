...
RtVoid RiNopConeV(RtFloat height, RtFloat radius, RtFloat thetamax, RtInt n, RtToken tokens[], RtPointer parms[]) {
    (void)height;
    (void)radius;
    (void)thetamax;
    (void)n;
...
RtVoid RiNopCropWindow(RtFloat xmin, RtFloat xmax, RtFloat ymin, RtFloat ymax) {
    (void)xmin;
    (void)xmax;
    (void)ymin;
    (void)ymax;
...
RtVoid RiNopCurves(RtToken type, RtInt ncurves, RtInt nvertices[], RtToken wrap, ...) {
    (void)type;
    (void)ncurves;
    (void)nvertices;
    (void)wrap;
...
RtVoid RiNopCurvesV(RtToken type, RtInt ncurves, RtInt nvertices[], RtToken wrap, RtInt n, RtToken tokens[], RtPointer parms[]) {
    (void)type;
    (void)ncurves;
    (void)nvertices;
    (void)wrap;
...
RtVoid RiNopCylinderV(RtFloat radius, RtFloat zmin, RtFloat zmax, RtFloat thetamax, RtInt n, RtToken tokens[], RtPointer parms[]) {
    (void)radius;
    (void)zmin;
    (void)zmax;
    (void)thetamax;
...
RtVoid RiNopDepthOfField(RtFloat fstop, RtFloat focallength, RtFloat focaldistance) {
    (void)fstop;
    (void)focallength;
    (void)focaldistance;
}
...
RtVoid RiNopDetailRange(RtFloat minvisible, RtFloat lowertransition, RtFloat uppertransition, RtFloat maxvisible) {
    (void)minvisible;
    (void)lowertransition;
    (void)uppertransition;
    (void)maxvisible;
}

RtVoid RiNopDiskV(RtFloat height, RtFloat radius, RtFloat thetamax, RtInt n, RtToken tokens[], RtPointer parms[]) {
    (void)height;
    (void)radius;
    (void)thetamax;
    (void)n;
...
RtVoid RiNopDisplayV(char *name, RtToken type, RtToken mode, RtInt n, RtToken tokens[], RtPointer parms[]) {
    (void)name;
    (void)type;
    (void)mode;
    (void)n;
...
RtVoid RiNopGeneralPolygonV(RtInt nloops, RtInt nvertices[], RtInt n, RtToken tokens[], RtPointer parms[]) {
    (void)nloops;
    (void)nvertices;
    (void)n;
    (void)tokens;
...
RtVoid RiNopHyperboloidV(RtPoint point1, RtPoint point2, RtFloat thetamax, RtInt n, RtToken tokens[], RtPointer parms[]) {
    (void)point1;
    (void)point2;
    (void)thetamax;
    (void)n;
...
RtVoid RiNopImplicitV(RtInt a, RtInt b[], RtInt c, RtFloat d[], RtInt e, RtFloat f[], RtInt g, RtFloat h[], RtInt n, RtToken tokens[], RtPointer parms[]) {
    (void)a;
    (void)b;
    (void)c;
    (void)d;
...
RtVoid RiNopMakeBumpV(char *picturename, char *texturename, RtToken swrap, RtToken twrap, RtFilterFunc filterfunc, RtFloat swidth, RtFloat twidth, RtInt n, RtToken tokens[], RtPointer parms[]) {
    (void)picturename;
    (void)texturename;
    (void)swrap;
    (void)twrap;
...
RtVoid RiNopMakeCubeFaceEnvironmentV(char *px, char *nx, char *py, char *ny, char *pz, char *nz, char *texturename, RtFloat fov, RtFilterFunc filterfunc, RtFloat swidth, RtFloat twidth, RtInt n, RtToken tokens[], RtPointer parms[]) {
    (void)px;
    (void)nx;
    (void)py;
    (void)ny;
...
RtVoid RiNopMakeLatLongEnvironmentV(char *picturename, char *texturename, RtFilterFunc filterfunc, RtFloat swidth, RtFloat twidth, RtInt n, RtToken tokens[], RtPointer parms[]) {
    (void)picturename;
    (void)texturename;
    (void)filterfunc;
    (void)swidth;
...
RtVoid RiNopMakeShadowV(char *picturename, char *texturename, RtInt n, RtToken tokens[], RtPointer parms[]) {
    (void)picturename;
    (void)texturename;
    (void)n;
    (void)tokens;
...
RtVoid RiNopMakeTextureV(char *picturename, char *texturename, RtToken swrap, RtToken twrap, RtFilterFunc filterfunc, RtFloat swidth, RtFloat twidth, RtInt n, RtToken tokens[], RtPointer parms[]) {
    (void)picturename;
    (void)texturename;
    (void)swrap;
    (void)twrap;
...
RtVoid RiNopNuCurvesV(RtInt ncurves, RtInt nvertices[], RtInt order[], RtFloat knot[], RtFloat min[], RtFloat max[], RtInt n, RtToken tokens[], RtPointer parms[]) {
    (void)ncurves;
    (void)nvertices;
    (void)order;
    (void)knot;
...
RtVoid RiNopNuPatchV(RtInt nu, RtInt uorder, RtFloat uknot[], RtFloat umin, RtFloat umax, RtInt nv, RtInt vorder, RtFloat vknot[], RtFloat vmin, RtFloat vmax, RtInt n, RtToken tokens[], RtPointer parms[]) {
    (void)nu;
    (void)uorder;
    (void)uknot;
    (void)umin;
...
RtVoid RiNopPatchMeshV(RtToken type, RtInt nu, RtToken uwrap, RtInt nv, RtToken vwrap, RtInt n, RtToken tokens[], RtPointer parms[]) {
    (void)type;
    (void)nu;
    (void)uwrap;
    (void)nv;
...
RtVoid RiNopPointsGeneralPolygonsV(RtInt npolys, RtInt nloops[], RtInt nvertices[], RtInt vertices[], RtInt n, RtToken tokens[], RtPointer parms[]) {
    (void)npolys;
    (void)nloops;
    (void)nvertices;
    (void)vertices;
...
RtVoid RiNopPointsPolygonsV(RtInt npolys, RtInt nvertices[], RtInt vertices[], RtInt n, RtToken tokens[], RtPointer parms[]) {
    (void)npolys;
    (void)nvertices;
    (void)vertices;
    (void)n;
...
RtVoid RiNopQuantize(RtToken type, RtInt one, RtInt min, RtInt max, RtFloat ampl) {
    (void)type;
    (void)one;
    (void)min;
    (void)max;
...
RtVoid RiNopResourceV(RtToken handle, RtToken type, RtInt n, RtToken tokens[], RtPointer parms[]) {
    (void)handle;
    (void)type;
    (void)n;
    (void)tokens;
...
RtVoid RiNopScreenWindow(RtFloat left, RtFloat right, RtFloat bottom, RtFloat top) {
    (void)left;
    (void)right;
    (void)bottom;
    (void)top;
...
RtVoid RiNopSkew(RtFloat angle, RtFloat dx1, RtFloat dy1, RtFloat dz1, RtFloat dx2, RtFloat dy2, RtFloat dz2) {
    (void)angle;
    (void)dx1;
    (void)dy1;
    (void)dz1;
...
RtVoid RiNopSphereV(RtFloat radius, RtFloat zmin, RtFloat zmax, RtFloat thetamax, RtInt n, RtToken tokens[], RtPointer parms[]) {
    (void)radius;
    (void)zmin;
    (void)zmax;
    (void)thetamax;
...
RtVoid RiNopSubdivisionMeshV(RtToken scheme, RtInt nfaces, RtInt nvertices[], RtInt vertices[], RtInt ntags, RtToken tags[], RtInt nargs[], RtInt intargs[], RtFloat floatargs[], RtInt n, RtToken tokens[], RtPointer parms[]) {
    (void)scheme;
    (void)nfaces;
    (void)nvertices;
    (void)vertices;
...
RtVoid RiNopTextureCoordinates(RtFloat s1, RtFloat t1, RtFloat s2, RtFloat t2, RtFloat s3, RtFloat t3, RtFloat s4, RtFloat t4) {
    (void)s1;
    (void)t1;
    (void)s2;
    (void)t2;
...
RtVoid RiNopTorusV(RtFloat majorradius, RtFloat minorradius, RtFloat phimin, RtFloat phimax, RtFloat thetamax, RtInt n, RtToken tokens[], RtPointer parms[]) {
    (void)majorradius;
    (void)minorradius;
    (void)phimin;
    (void)phimax;
...
RtVoid RiNopTrimCurve(RtInt nloops, RtInt ncurves[], RtInt order[], RtFloat knot[], RtFloat min[], RtFloat max[], RtInt n[], RtFloat u[], RtFloat v[], RtFloat w[]) {
    (void)nloops;
    (void)ncurves;
    (void)order;
    (void)knot;
...
RtVoid RiNopProcedural(RtPointer data, RtBound bound, RtVoid (*subdivfunc)(RtPointer, RtFloat), RtVoid (*freefunc)(RtPointer)) {
    (void)data;
    (void)bound;
    (void)subdivfunc;
    (void)freefunc;
...
RtPoint *RiNopTransformPoints(RtToken fromspace, RtToken tospace, RtInt n, RtPoint points[]) {
    (void)fromspace;
    (void)tospace;
    (void)n;
    (void)points;
...
RtFloat RiNopTriangleFilter(RtFloat x, RtFloat y, RtFloat xwidth, RtFloat ywidth) {
    (void)x;
    (void)y;
    (void)xwidth;
    (void)ywidth;
...
RtFloat RiNopCatmullRomFilter(RtFloat x, RtFloat y, RtFloat xwidth, RtFloat ywidth) {
    (void)x;
    (void)y;
    (void)xwidth;
    (void)ywidth;
...
RtFloat RiNopGaussianFilter(RtFloat x, RtFloat y, RtFloat xwidth, RtFloat ywidth) {
    (void)x;
    (void)y;
    (void)xwidth;
    (void)ywidth;
