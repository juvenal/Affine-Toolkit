...
int RibMemoryTestMalloc(char *file, unsigned int line, void *p, unsigned int size) {
    PMEM_LIST l;
...
PRIB_HASHATOM RibHash(RIB_HASHHND hash, int type, int code, char *s, PRIB_HASHATOM **pparentnext) {
    int h1, h2;
    PRIB_HASHATOM p, *pp;
