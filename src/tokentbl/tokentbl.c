...
int SetUpTree(char t[255][255], int BaseIndex, int UpTo, int InToString, char *Output);
...
int SetUpTree(char t[255][255], int BaseIndex, int UpToIndex, int InToString, char *Output) {
    int Length = 0;
    char *p, *p1, *p2;
    int i, k, l, g;
