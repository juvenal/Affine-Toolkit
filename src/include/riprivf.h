...
typedef RtVoid (*PRiScreenWindow)(RtFloat left, RtFloat right, RtFloat bottom, RtFloat top);
typedef RtVoid (*PRiClipping)(RtFloat hither, RtFloat yon);
typedef RtVoid (*PRiCropWindow)(RtFloat xmin, RtFloat xmax, RtFloat ymin, RtFloat ymax);
typedef RtVoid (*PRiDepthOfField)(RtFloat fstop, RtFloat focallength, RtFloat focaldistance);
typedef RtVoid (*PRiProcedural)(RtPointer data, RtBound bound, RtVoid (*subdivfunc)(RtPointer, RtFloat), RtVoid (*freefunc)(RtPointer));
...
typedef RtVoid (*PRiDisplayV)(char *name, RtToken type, RtToken mode, RtInt n, RtToken tokens[], RtPointer parms[]);
...
typedef RtVoid (*PRiQuantize)(RtToken type, RtInt one, RtInt min, RtInt max, RtFloat ampl);
...
typedef RtPoint *(*PRiTransformPoints)(RtToken fromspace, RtToken tospace, RtInt n, RtPoint points[]);
...
typedef RtVoid (*PRiTextureCoordinates)(RtFloat s1, RtFloat t1, RtFloat s2, RtFloat t2, RtFloat s3, RtFloat t3, RtFloat s4, RtFloat t4);
...
typedef RtVoid (*PRiBasis)(RtBasis ubasis, RtInt ustep, RtBasis vbasis, RtInt vstep);
...
typedef RtVoid (*PRiNuPatchV)(RtInt nu, RtInt uorder, RtFloat uknot[], RtFloat umin, RtFloat umax, RtInt nv, RtInt vorder, RtFloat vknot[], RtFloat vmin, RtFloat vmax, RtInt n, RtToken tokens[], RtPointer parms[]);
typedef RtVoid (*PRiTrimCurve)(RtInt nloops, RtInt ncurves[], RtInt order[], RtFloat knot[], RtFloat min[], RtFloat max[], RtInt n[], RtFloat u[], RtFloat v[], RtFloat w[]);

typedef RtVoid (*PRiConeV)(RtFloat height, RtFloat radius, RtFloat thetamax, RtInt n, RtToken tokens[], RtPointer parms[]);
typedef RtVoid (*PRiCurvesV)(RtToken type, RtInt ncurves, RtInt nvertices[], RtToken wrap, RtInt n, RtToken tokens[], RtPointer parms[]);
typedef RtVoid (*PRiCylinderV)(RtFloat radius,
                               ...
                               RtToken tokens[],
                               RtPointer parms[]);
typedef RtVoid (*PRiDiskV)(RtFloat height, RtFloat radius, RtFloat thetamax, RtInt n, RtToken tokens[], RtPointer parms[]);
typedef RtVoid (*PRiHyperboloidV)(RtPoint point1, RtPoint point2, RtFloat thetamax, RtInt n, RtToken tokens[], RtPointer parms[]);
...
typedef RtVoid (*PRiSphereV)(RtFloat radius,
                             ...
                             RtToken tokens[],
                             RtPointer parms[]);
typedef RtVoid (*PRiTorusV)(RtFloat majorradius, RtFloat minorradius, RtFloat phimin, RtFloat phimax, RtFloat thetamax, RtInt n, RtToken tokens[], RtPointer parms[]);

typedef RtVoid (*PRiPointsV)(RtInt npoints,
                             RtInt n,
                             RtToken tokens[],
                             RtPointer parms[]);
typedef RtVoid (*PRiGeneralPolygonV)(RtInt nloops, RtInt nvertices[], RtInt n, RtToken tokens[], RtPointer parms[]);
typedef RtVoid (*PRiPointsGeneralPolygonsV)(RtInt npolys, RtInt nloops[], RtInt nvertices[], RtInt vertices[], RtInt n, RtToken tokens[], RtPointer parms[]);
...
typedef RtVoid (*PRiSubdivisionMeshV)(RtToken scheme, RtInt nfaces, RtInt nvertices[], RtInt vertices[], RtInt ntags, RtToken tags[], RtInt nargs[], RtInt intargs[], RtFloat floatargs[], RtInt n, RtToken tokens[], RtPointer parms[]);
typedef RtVoid (*PRiImplicitV)(RtInt a, RtInt b[], RtInt, RtFloat c[], RtInt d, RtFloat e[], RtInt f, RtFloat g[], RtInt n, RtToken tokens[], RtPointer parms[]);
typedef RtVoid (*PRiNuCurvesV)(RtInt ncurves, RtInt nvertices[], RtInt order[], RtFloat knot[], RtFloat min[], RtFloat max[], RtInt n, RtToken tokens[], RtPointer parms[]);
...
typedef RtVoid (*PRiDetailRange)(RtFloat minvisible, RtFloat lowertransition, RtFloat uppertransition, RtFloat maxvisible);
...
typedef RtVoid (*PRiMakeBumpV)(char *picturename, char *texturename, RtToken swrap, RtToken twrap, RtFilterFunc filterfunc, RtFloat swidth, RtFloat twidth, RtInt n, RtToken tokens[], RtPointer parms[]);
typedef RtVoid (*PRiMakeCubeFaceEnvironmentV)(char *px, char *nx, char *py, char *ny, char *pz, char *nz, char *texturename, RtFloat fov, RtFilterFunc filterfunc, RtFloat swidth, RtFloat twidth, RtInt n, RtToken tokens[], RtPointer parms[]);
typedef RtVoid (*PRiMakeLatLongEnvironmentV)(
    char *picturename, char *texturename, RtFilterFunc filterfunc, RtFloat swidth, RtFloat twidth, RtInt n, RtToken tokens[], RtPointer parms[]);
typedef RtVoid (*PRiMakeShadowV)(char *picturename, char *texturename, RtInt n, RtToken tokens[], RtPointer parms[]);
typedef RtVoid (*PRiMakeTextureV)(char *picturename, char *texturename, RtToken swrap, RtToken twrap, RtFilterFunc filterfunc, RtFloat swidth, RtFloat twidth, RtInt n, RtToken tokens[], RtPointer parms[]);
typedef RtVoid (*PRiResourceV)(RtToken handle, RtToken type, RtInt n, RtToken tokens[], RtPointer parms[]);
typedef RtVoid (*PRiGeometricRepresentation)(RtToken type);

typedef RtFloat (*PRiBoxFilter)(RtFloat x, RtFloat y, RtFloat xwidth, RtFloat ywidth);
typedef RtFloat (*PRiTriangleFilter)(RtFloat x, RtFloat y, RtFloat xwidth, RtFloat ywidth);
typedef RtFloat (*PRiCatmullRomFilter)(RtFloat x, RtFloat y, RtFloat xwidth, RtFloat ywidth);
typedef RtFloat (*PRiGaussianFilter)(RtFloat x, RtFloat y, RtFloat xwidth, RtFloat ywidth);
typedef RtFloat (*PRiSincFilter)(RtFloat x, RtFloat y, RtFloat xwidth, RtFloat ywidth);
