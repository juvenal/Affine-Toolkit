...
#endif
    int
    RibReadStringForToken(const char *s, const char *table, char **tokenend),
    RibGetUserParameters(char *table, int ntable, RtInt n, RtToken tokens[], RtPointer parms[], RtPointer output[]);
