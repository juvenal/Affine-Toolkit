...
int WriteIff(PBITMAP pBmp, char *filename, int rle) {
    ...
    if ((pBmp->sampleformat != BITMAP_UINT8 && pBmp->sampleformat != BITMAP_UINT16) || (pBmp->bitspersample != 8 && pBmp->bitspersample != 16) || (/*pBmp->nsamples != 1 && */ /*Don't support grayscale for now.*/
                                                                                                                                                       pBmp->nsamples != 3 &&
                                                                                                                                                   pBmp->nsamples != 4) ||
