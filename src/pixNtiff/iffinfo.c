...
#define TAG(a, b, c, d) (unsigned int)((((unsigned int)(a)) << 24) | (((unsigned int)(b)) << 16) | (((unsigned int)(c)) << 8) | (((unsigned int)(d))))
#else
#define TAG(a, b, c, d) (unsigned int)((((unsigned int)(d)) << 24) | (((unsigned int)(c)) << 16) | (((unsigned int)(b)) << 8) | (((unsigned int)(a))))
#endif
...
int handlechunk(FILE *iff, PGROUP groups, char tag[4], int id) {
    ...
    if (size & 0x80000000 /* Do the AND as a quick test. */
        && (id == IFFDATABLOCK_BLCK || id == IFFDATABLOCK_EOVC || id == IFFDATABLOCK_GEND) && (size == 0x80000000 || size == 0x80000001 || size == 0x80000002)) {
