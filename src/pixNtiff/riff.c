...
PBITMAP ReadIff(char *filename, unsigned int iffflags) {
    ...
    for (;;) {
        ...
        if (tiles && b[0] == 'R' && b[1] == 'G' && b[2] == 'B' && b[3] == 'A') {
            ...
            else if (sampleformat == BITMAP_UINT8 && tilecompressed && (nsamples == 1 || nsamples == 3 || nsamples == 4)) {
            ...
            else if (sampleformat == BITMAP_UINT16 && tilecompressed && (nsamples == 1 || nsamples == 3 || nsamples == 4)) {
#ifdef LITTLE_ENDIAN
        ...
        else if (rgb2 && tiles2 && b[0] == 'R' && b[1] == 'G' && b[2] == 'B' && b[3] == '2') {
            /* Read RGBA rectangle coordinates. */
            if (fread(b, 1, 8, iff) < 8)
                goto Error;
            if (size < 8)
    ...
    if ((READIFF_CONVERT16TO8 & iffflags) && pBmp->sampleformat == BITMAP_UINT16 && pBmp->bitspersample == 16) {
